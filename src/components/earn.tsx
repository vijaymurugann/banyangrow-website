...
const WaysToEarn = () => {
  return (
    <section className="relative w-full min-h-screen bg-black flex flex-col items-center justify-center px-8">
      ...
      {/* Title - Visible on Desktop, Adjusted for Mobile */}
      <div className="w-full text-center z-10 mt-10 md:absolute md:w-[calc(60%+20px)] md:h-[calc(60%+20px)] md:flex md:flex-col md:items-center md:justify-center">
...
const EarningBox = ({ image, title, description }) => (
